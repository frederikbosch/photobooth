...
cp /media/dc7aa23f-297e-43c3-a1f4-64765c52c43c/home/ssh.inid /etc/init.d/ssh
...
wget https://github.com/frederikbosch/photobooth/blob/master/src/print.sh -O /root/print.sh
